$(function () {
	...
	var filterSubNavWrapper = $("#sq-filters .sub-nav-wrapper"), filterSubNav = filterSubNavWrapper.find(".sub-nav");
	...
	var ribbonItem = $(".sq-top-ribbon > ul > li > ul > li"), subNavMultiSelct = $(".sub-nav .ms-parent").children();
	(ribbonItem.children(), filterSubNav, $(".sub-nav .ms-parent").children(), $(".sq-top-ribbon select")).on("click", function (e) {
		e.stopPropagation()
	});
	$(".has-subnav").on("mouseover", function () {
	...
	$(".editor").kendoEditor({resizable: {content: true, toolbar: true}});
